...
public class Result
{
    ...
    /// <summary>
    /// Indica el código http del error en caso de ser necesario
    /// </summary>
    public ErrorType? ErrorTypeCode { get; }
    ...
    /// </exception>
    protected Result(bool isSuccess, ICollection<string>? errors = null, ErrorType? errorTypeCode = null)
    {
    ...
    /// </summary>
    /// <param name="error">Mensaje con el error ocurrido</param>
    public static Result BadRequest(string error) => new Result(false, [error], errorTypeCode: ErrorType.BadRequest);
    ...
    /// </summary>
    /// <param name="error">Mensaje con el error ocurrido</param>
    public static Result NotFound(string error) => new Result(false, [error], errorTypeCode: ErrorType.NotFound);

    /// <summary>
    /// Factory method para crear un Result fallido con error de tipo Forbidden sin valor de retorno
    /// </summary>
    /// <param name="error">Mensaje con el error ocurrido</param>
    public static Result Forbidden(string error) => new Result(false, [error], errorTypeCode: ErrorType.Forbidden);
    ...
    /// <typeparam name="T">Tipo que debería retornar en caso de éxito</typeparam>
    /// <param name="errors">Lista de errores</param>
    public static Result<T> NotFound<T>(List<string> errors) => new Result<T>(false, errors, errorTypeCode: ErrorType.NotFound);
    ...
    /// <typeparam name="T">Tipo que debería retornar en caso de éxito</typeparam>
    /// <param name="error">Mensaje con el error ocurrido</param>
    public static Result<T> NotFound<T>(string error) => new Result<T>(false, [error], errorTypeCode: ErrorType.NotFound);

    /// <summary>
    /// Factory method para crear un Result fallido con tipo específico y error de tipo BadRequest
    /// </summary>
    /// <typeparam name="T">Tipo que debería retornar en caso de éxito</typeparam>
    /// <param name="errors">Lista de errores</param>
    public static Result<T> BadRequest<T>(List<string> errors) => new Result<T>(false, errors, errorTypeCode: ErrorType.BadRequest);
    ...
    /// <typeparam name="T">Tipo que debería retornar en caso de éxito</typeparam>
    /// <param name="error">Mensaje con el error ocurrido</param>
    public static Result<T> Forbidden<T>(string error) => new Result<T>(false, [error], errorTypeCode: ErrorType.Forbidden);
    ...
    /// <typeparam name="T">Tipo que debería retornar en caso de éxito</typeparam>
    /// <param name="errors">Lista de errores</param>
    public static Result<T> Forbidden<T>(List<string> errors) => new Result<T>(false, errors, errorTypeCode: ErrorType.Forbidden);

    /// <summary>
    /// Factory method para crear un Result fallido con tipo específico y error de tipo Locked
    /// </summary>
    /// <typeparam name="T">Tipo que debería retornar en caso de éxito</typeparam>
    /// <param name="error">Mensaje con el error ocurrido</param>
    public static Result<T> Locked<T>(string error) => new Result<T>(false, [error], errorTypeCode: ErrorType.Locked);

    /// <summary>
    /// Factory method para crear un Result fallido con tipo específico y error de tipo Unauthorized
    /// </summary>
    /// <typeparam name="T">Tipo que debería retornar en caso de éxito</typeparam>
    /// <param name="error">Mensaje con el error ocurrido</param>
    public static Result<T> Unauthorized<T>(string error) => new Result<T>(false, [error], errorTypeCode: ErrorType.Unauthorized);
}